                            ...
                            if file.is_file():
                                ...
                                for category, extensions in self.file_extensions.items():
                                    if extension in extensions:
                                        target_folder = os.path.join(year_path, category)
                                        os.makedirs(target_folder, exist_ok=True)
                                        shutil.move(file.path, os.path.join(target_folder, file.name))
                                        logging.info(f"Moved file {file.name} to {target_folder}")
